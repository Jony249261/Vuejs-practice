            ...
            <div class="row">
                    ...
                    <div class="categories_post">
                        ...
                        <div class="categories_details">
                            <div class="categories_text">
                                <router-link :to="{name: 'singleblog' }"><h5>Social Life</h5></router-link>
                ...
                <div class="col-lg-4">
                    <div class="categories_post">
                        ...
                        <div class="categories_details">
                            <div class="categories_text">
                                <router-link :to="{name: 'singleblog' }"><h5>Politics</h5></router-link>
                                <div class="border_line"></div>
                ...
                <div class="col-lg-4">
                    <div class="categories_post">
                        ...
                        <div class="categories_details">
                            <div class="categories_text">
                                <router-link :to="{name: 'singleblog' }"><h5>Food</h5></router-link>
                                <div class="border_line"></div>
                            ...
                            <div class="col-md-9">
                                <div class="blog_post">
                                    ...
                                    <div class="blog_details">
                                       ...
                                       <router-link :to="{name: 'singleblog' }" class="primary_btn"><span>View More</span></router-link>
                                    </div>
                                </div>
                            </div>
                        </article>
                        <article class="row blog_item">
                            ...
                            <div class="col-md-9">
                                <div class="blog_post">
                                    ...
                                    <div class="blog_details">
                                        <router-link :to="{name: 'singleblog' }"><h2>The Basics Of Buying A Telescope</h2></router-link>
                                        <p>MCSE boot camps have its supporters and its detractors. Some people do not understand why you should have to spend money on boot camp when you can get the MCSE study materials yourself at a fraction.</p>
                                        <router-link :to="{name: 'singleblog' }" class="primary_btn"><span>View More</span></router-link>
                                    </div>
                                </div>
                        ...
                        <article class="row blog_item">
                            ...
                            <div class="col-md-9">
                                <div class="blog_post">
                                    ...
                                    <div class="blog_details">
                                        <router-link :to="{name: 'singleblog' }"><h2>The Glossary Of Telescopes</h2></router-link>
                                        <p>MCSE boot camps have its supporters and its detractors. Some people do not understand why you should have to spend money on boot camp when you can get the MCSE study materials yourself at a fraction.</p>
                                       <router-link :to="{name: 'singleblog' }" class="primary_btn"><span>View More</span></router-link>
                                    </div>
                                </div>
                        ...
                        <article class="row blog_item">
                            ...
                            <div class="col-md-9">
                                <div class="blog_post">
                                    ...
                                    <div class="blog_details">
                                       <router-link :to="{name: 'singleblog' }"><h2>The Night Sky</h2></router-link>
                                        <p>MCSE boot camps have its supporters and its detractors. Some people do not understand why you should have to spend money on boot camp when you can get the MCSE study materials yourself at a fraction.</p>
                                       <router-link :to="{name: 'singleblog' }" class="primary_btn"><span>View More</span></router-link>
                                    </div>
                                </div>
                        ...
                        <article class="row blog_item">
                            ...
                            <div class="col-md-9">
                                <div class="blog_post">
                                    ...
                                    <div class="blog_details">
                                        <router-link :to="{name: 'singleblog' }"><h2>Telescopes 101</h2></router-link>
                                        <p>MCSE boot camps have its supporters and its detractors. Some people do not understand why you should have to spend money on boot camp when you can get the MCSE study materials yourself at a fraction.</p>
                                        <router-link :to="{name: 'singleblog' }" class="primary_btn"><span>View More</span></router-link>
                                    </div>
                                </div>
                        ...
                        <aside class="single_sidebar_widget popular_post_widget">
                            ...
                            <div class="media post_item">
                                ...
                                <div class="media-body">
                                    <router-link :to="{name: 'singleblog' }"><h3>Space The Final Frontier</h3></router-link>
                                    <p>02 Hours ago</p>
                                </div>
                            </div>
                            <div class="media post_item">
                                ...
                                <div class="media-body">
                                    <router-link :to="{name: 'singleblog' }"><h3>The Amazing Hubble</h3></router-link>
                                    <p>02 Hours ago</p>
                                </div>
                            </div>
                            <div class="media post_item">
                                ...
                                <div class="media-body">
                                   <router-link :to="{name: 'singleblog' }"><h3>Astronomy Or Astrology</h3></router-link>
                                    <p>03 Hours ago</p>
                                </div>
                            </div>
                            <div class="media post_item">
                                ...
                                <div class="media-body">
                                    <router-link :to="{name: 'singleblog' }"><h3>Asteroids telescope</h3></router-link>
                                    <p>01 Hours ago</p>
                                </div>
                            </div>
                            <div class="br"></div>
