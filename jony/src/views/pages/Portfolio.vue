				...
				<div class="row portfolio-grid justify-content-center">
					<div class="col-lg-4 col-md-6 all latest">
						<div class="portfolio_box">
							...
							<div class="short_info">
								<h4><router-link :to="{name: 'portfoliodetails' }">minimal design</router-link></h4>
					...
					<div class="col-lg-4 col-md-6 all popular">
						<div class="portfolio_box">
							...
							<div class="short_info">
								<h4><router-link :to="{name: 'portfoliodetails' }">Paint wall</router-link></h4>
								<p>Animated, portfolio</p>
							</div>
						</div>
					</div>
					<div class="col-lg-4 col-md-6 all latest">
						<div class="portfolio_box">
							...
							<div class="short_info">
								<h4><router-link :to="{name: 'portfoliodetails' }">female light</router-link></h4>
								<p>Animated, portfolio</p>
							</div>
						</div>
					</div>
					<div class="col-lg-4 col-md-6 all popular">
						<div class="portfolio_box">
							...
							<div class="short_info">
								<h4><router-link :to="{name: 'portfoliodetails' }">fourth air</router-link></h4>
								<p>Animated, portfolio</p>
							</div>
						</div>
					</div>
					<div class="col-lg-4 col-md-6 all following">
						<div class="portfolio_box">
							...
							<div class="short_info">
								<h4><router-link :to="{name: 'portfoliodetails' }">together sign</router-link></h4>
								<p>Animated, portfolio</p>
							</div>
						</div>
					</div>
					<div class="col-lg-4 col-md-6 all upcoming">
						<div class="portfolio_box">
							...
							<div class="short_info">
								<h4><router-link :to="{name: 'portfoliodetails' }">multiply fowl</router-link></h4>
								<p>Animated, portfolio</p>
							</div>
						</div>
					</div>
					<div class="col-lg-4 col-md-6 all upcoming following">
						<div class="portfolio_box">
							...
							<div class="short_info">
								<h4><router-link :to="{name: 'portfoliodetails' }">green heaven</router-link></h4>
								<p>Animated, portfolio</p>
							</div>
						</div>
					</div>
					<div class="col-lg-4 col-md-6 all following">
						<div class="portfolio_box">
							...
							<div class="short_info">
								<h4><router-link :to="{name: 'portfoliodetails' }">fly male</router-link></h4>
								<p>Animated, portfolio</p>
							</div>
						</div>
					</div>
					<div class="col-lg-4 col-md-6 all upcoming">
						<div class="portfolio_box">
							...
							<div class="short_info">
								<h4><router-link :to="{name: 'portfoliodetails' }">season face</router-link></h4>
								<p>Animated, portfolio</p>
							</div>
						</div>
					</div>
